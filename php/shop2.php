...
<div class="main">
	 ...
	 <main>
	   <!-- <img src="../images/shop/8.jpg.png" alt=""> -->
<div class="main-wrapper">
<section class="sub-header">
 <!-- <div class="search">
	 <form method = "post" action="searchresults.php">
		<input type="text" placeholder="Search" name="shopsearch" class="SSearch">
   ...
   <div class="search-section">
	 ...
	 <div class="flex row">
	   <div class="search-container">
		 ...
		 <input class="search-bar" type="text" value="Search here" name="shopsearch"/>
   ...
   <div class="cat-container">
	 <div class="cat">
	   ...
	   <p id="cat-1" class="cat-title">Pet Food</p>
	 </div>
	 <div class="cat">
	   <img id="img-cat-1" src="http://placehold.jp/40x40.png" alt="" />
	   <p id="cat-1" class="cat-title">Pet Food</p>
    ...
    <div class="main2"> <?php 
         ...
         if($result = $conn->query($sql))
         {
           ...
           while ($row=$result->fetch_assoc()) { 
            ...
            echo "<div class='alb'>
            <a href='item.php? name={$row["name"]}'><img class = 'image2' src='{$row["photo"]}'><h4>{$row["name"]}</h4></a>
